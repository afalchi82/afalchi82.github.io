...
comodinoEl.setAttribute('material', materials.canapa);
...
const maniglia1El = makeBox(maniglia, materials.canapa);
...
const maniglia2El = makeBox(maniglia, materials.canapa);
setPos(maniglia2El, [
    maniglia.x, 
    cassetto.height, 
    maniglia.z
