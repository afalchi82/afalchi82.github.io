 ...
 * @license Apache-2.0
 * @since 3.0.0
 */class a extends e{constructor(e,t){super(),this._output=e,this._number=t,this._octaveOffset=0}destroy(){this._output=null,this._number=null,this._octaveOffset=0,this.removeListener()}send(e,t={time:0}){return this.output.send(e,t),this}sendKeyAftertouch(e,t,s={}){if(u.validation){if(s.useRawValue&&(s.rawValue=s.useRawValue),isNaN(parseFloat(t)))throw new RangeError("Invalid key aftertouch value.");if(s.rawValue){if(!(t>=0&&t<=127&&Number.isInteger(t)))throw new RangeError("Key aftertouch raw value must be an integer between 0 and 127.")}else if(!(t>=0&&t<=1))throw new RangeError("Key aftertouch value must be a float between 0 and 1.")}s.rawValue||(t=r.fromFloatTo7Bit(t));const a=u.octaveOffset+this.output.octaveOffset+this.octaveOffset;return Array.isArray(e)||(e=[e]),r.buildNoteArray(e).forEach(e=>{this.send([(n.MIDI_CHANNEL_MESSAGES.keyaftertouch<<4)+(this.number-1),e.getOffsetNumber(a),t],{time:r.toTimestamp(s.time)})}),this}
/**
   ...
   * @license Apache-2.0
   * @since 3.0.0
   */sendControlChange(e,t,s={}){if("string"==typeof e&&(e=n.MIDI_CONTROL_CHANGE_MESSAGES[e]),Array.isArray(t)||(t=[t]),u.validation){if(void 0===e)throw new TypeError("Control change must be identified with a valid name or an integer between 0 and 127.");if(!Number.isInteger(e)||!(e>=0&&e<=127))throw new TypeError("Control change number must be an integer between 0 and 127.");if(2===(t=t.map(e=>{const t=Math.min(Math.max(parseInt(e),0),127);if(isNaN(t))throw new TypeError("Values must be integers between 0 and 127");return t})).length&&e>=32)throw new TypeError("To use a value array, the controller must be between 0 and 31")}return t.forEach((a,i)=>{this.send([(n.MIDI_CHANNEL_MESSAGES.controlchange<<4)+(this.number-1),e+32*i,t[i]],{time:r.toTimestamp(s.time)})}),this}_selectNonRegisteredParameter(e,t={}){return this.sendControlChange(99,e[0],t),this.sendControlChange(98,e[1],t),this}_deselectRegisteredParameter(e={}){return this.sendControlChange(101,127,e),this.sendControlChange(100,127,e),this}_deselectNonRegisteredParameter(e={}){return this.sendControlChange(101,127,e),this.sendControlChange(100,127,e),this}_selectRegisteredParameter(e,t={}){return this.sendControlChange(101,e[0],t),this.sendControlChange(100,e[1],t),this}_setCurrentParameter(e,t={}){return e=[].concat(e),this.sendControlChange(6,e[0],t),e.length<2||this.sendControlChange(38,e[1],t),this}sendRpnDecrement(e,t={}){if(Array.isArray(e)||(e=n.MIDI_REGISTERED_PARAMETERS[e]),u.validation){if(void 0===e)throw new TypeError("The specified registered parameter is invalid.");let t=!1;if(Object.getOwnPropertyNames(n.MIDI_REGISTERED_PARAMETERS).forEach(s=>{n.MIDI_REGISTERED_PARAMETERS[s][0]===e[0]&&n.MIDI_REGISTERED_PARAMETERS[s][1]===e[1]&&(t=!0)}),!t)throw new TypeError("The specified registered parameter is invalid.")}return this._selectRegisteredParameter(e,t),this.sendControlChange(97,0,t),this._deselectRegisteredParameter(t),this}sendRpnIncrement(e,t={}){if(Array.isArray(e)||(e=n.MIDI_REGISTERED_PARAMETERS[e]),u.validation){if(void 0===e)throw new TypeError("The specified registered parameter is invalid.");let t=!1;if(Object.getOwnPropertyNames(n.MIDI_REGISTERED_PARAMETERS).forEach(s=>{n.MIDI_REGISTERED_PARAMETERS[s][0]===e[0]&&n.MIDI_REGISTERED_PARAMETERS[s][1]===e[1]&&(t=!0)}),!t)throw new TypeError("The specified registered parameter is invalid.")}return this._selectRegisteredParameter(e,t),this.sendControlChange(96,0,t),this._deselectRegisteredParameter(t),this}playNote(e,t={}){if(this.sendNoteOn(e,t),t.duration>0&&isFinite(String(t.duration).trim()||NaN)){let n={time:(r.toTimestamp(t.time)||u.time)+t.duration,release:t.release,rawRelease:t.rawRelease};this.sendNoteOff(e,n)}return this}sendNoteOff(e,t={}){if(u.validation){if(null!=t.rawRelease&&!(t.rawRelease>=0&&t.rawRelease<=127))throw new RangeError("The 'rawRelease' option must be an integer between 0 and 127");if(null!=t.release&&!(t.release>=0&&t.release<=1))throw new RangeError("The 'release' option must be an number between 0 and 1");t.rawVelocity&&(t.rawRelease=t.velocity,console.warn("The 'rawVelocity' option is deprecated. Use 'rawRelease' instead.")),t.velocity&&(t.release=t.velocity,console.warn("The 'velocity' option is deprecated. Use 'attack' instead."))}let s=64;null!=t.rawRelease?s=t.rawRelease:isNaN(t.release)||(s=Math.round(127*t.release));const a=u.octaveOffset+this.output.octaveOffset+this.octaveOffset;return r.buildNoteArray(e,{rawRelease:parseInt(s)}).forEach(e=>{this.send([(n.MIDI_CHANNEL_MESSAGES.noteoff<<4)+(this.number-1),e.getOffsetNumber(a),e.rawRelease],{time:r.toTimestamp(t.time)})}),this}stopNote(e,t={}){return this.sendNoteOff(e,t)}sendNoteOn(e,t={}){if(u.validation){if(null!=t.rawAttack&&!(t.rawAttack>=0&&t.rawAttack<=127))throw new RangeError("The 'rawAttack' option must be an integer between 0 and 127");if(null!=t.attack&&!(t.attack>=0&&t.attack<=1))throw new RangeError("The 'attack' option must be an number between 0 and 1");t.rawVelocity&&(t.rawAttack=t.velocity,t.rawRelease=t.release,console.warn("The 'rawVelocity' option is deprecated. Use 'rawAttack' or 'rawRelease'.")),t.velocity&&(t.attack=t.velocity,console.warn("The 'velocity' option is deprecated. Use 'attack' instead."))}let s=64;null!=t.rawAttack?s=t.rawAttack:isNaN(t.attack)||(s=Math.round(127*t.attack));const a=u.octaveOffset+this.output.octaveOffset+this.octaveOffset;return r.buildNoteArray(e,{rawAttack:s}).forEach(e=>{this.send([(n.MIDI_CHANNEL_MESSAGES.noteon<<4)+(this.number-1),e.getOffsetNumber(a),e.rawAttack],{time:r.toTimestamp(t.time)})}),this}sendChannelMode(e,t=0,s={}){if("string"==typeof e&&(e=n.MIDI_CHANNEL_MODE_MESSAGES[e]),u.validation){if(void 0===e)throw new TypeError("Invalid channel mode message name or number.");if(isNaN(e)||!(e>=120&&e<=127))throw new TypeError("Invalid channel mode message number.");if(isNaN(parseInt(t))||t<0||t>127)throw new RangeError("Value must be an integer between 0 and 127.")}return this.send([(n.MIDI_CHANNEL_MESSAGES.controlchange<<4)+(this.number-1),e,t],{time:r.toTimestamp(s.time)}),this}sendOmniMode(e,t={}){return void 0===e||e?this.sendChannelMode("omnimodeon",0,t):this.sendChannelMode("omnimodeoff",0,t),this}sendChannelAftertouch(e,t={}){if(u.validation){if(isNaN(parseFloat(e)))throw new RangeError("Invalid channel aftertouch value.");if(t.rawValue){if(!(e>=0&&e<=127&&Number.isInteger(e)))throw new RangeError("Channel aftertouch raw value must be an integer between 0 and 127.")}else if(!(e>=0&&e<=1))throw new RangeError("Channel aftertouch value must be a float between 0 and 1.")}return this.send([(n.MIDI_CHANNEL_MESSAGES.channelaftertouch<<4)+(this.number-1),Math.round(127*e)],{time:r.toTimestamp(t.time)}),this}sendMasterTuning(e,t={}){if(e=parseFloat(e)||0,u.validation&&!(e>-65&&e<64))throw new RangeError("The value must be a decimal number larger than -65 and smaller than 64.");let n=Math.floor(e)+64,s=e-Math.floor(e);s=Math.round((s+1)/2*16383);let r=s>>7&127,a=127&s;return this.sendRpnValue("channelcoarsetuning",n,t),this.sendRpnValue("channelfinetuning",[r,a],t),this}sendModulationRange(e,t,n={}){if(u.validation){if(!Number.isInteger(e)||!(e>=0&&e<=127))throw new RangeError("The semitones value must be an integer between 0 and 127.");if(!(null==t||Number.isInteger(t)&&t>=0&&t<=127))throw new RangeError("If specified, the cents value must be an integer between 0 and 127.")}return t>=0&&t<=127||(t=0),this.sendRpnValue("modulationrange",[e,t],n),this}sendNrpnValue(e,t,n={}){if(t=[].concat(t),u.validation){if(!Array.isArray(e)||!Number.isInteger(e[0])||!Number.isInteger(e[1]))throw new TypeError("The specified NRPN is invalid.");if(!(e[0]>=0&&e[0]<=127))throw new RangeError("The first byte of the NRPN must be between 0 and 127.");if(!(e[1]>=0&&e[1]<=127))throw new RangeError("The second byte of the NRPN must be between 0 and 127.");t.forEach(e=>{if(!(e>=0&&e<=127))throw new RangeError("The data bytes of the NRPN must be between 0 and 127.")})}return this._selectNonRegisteredParameter(e,n),this._setCurrentParameter(t,n),this._deselectNonRegisteredParameter(n),this}sendPitchBend(e,t={}){if(u.validation)if(t.rawValue&&Array.isArray(e)){if(!(e[0]>=0&&e[0]<=127))throw new RangeError("The pitch bend MSB must be an integer between 0 and 127.");if(!(e[1]>=0&&e[1]<=127))throw new RangeError("The pitch bend LSB must be an integer between 0 and 127.")}else if(t.rawValue&&!Array.isArray(e)){if(!(e>=0&&e<=127))throw new RangeError("The pitch bend MSB must be an integer between 0 and 127.")}else{if(isNaN(e)||null===e)throw new RangeError("Invalid pitch bend value.");if(!(e>=-1&&e<=1))throw new RangeError("The pitch bend MSB must be an integer between 0 and 127.")}let s=0,a=0;if(t.rawValue&&Array.isArray(e))s=e[0],a=e[1];else if(t.rawValue&&!Array.isArray(e))s=e;else{const t=r.fromFloatToMsbLsb((e+1)/2);s=t.msb,a=t.lsb}return this.send([(n.MIDI_CHANNEL_MESSAGES.pitchbend<<4)+(this.number-1),a,s],{time:r.toTimestamp(t.time)}),this}sendPitchBendRange(e,t,n={}){if(u.validation){if(!Number.isInteger(e)||!(e>=0&&e<=127))throw new RangeError("The semitones value must be an integer between 0 and 127.");if(!Number.isInteger(t)||!(t>=0&&t<=127))throw new RangeError("The cents value must be an integer between 0 and 127.")}return this.sendRpnValue("pitchbendrange",[e,t],n),this}sendProgramChange(e,t={}){if(e=parseInt(e)||0,u.validation&&!(e>=0&&e<=127))throw new RangeError("The program number must be between 0 and 127.");return this.send([(n.MIDI_CHANNEL_MESSAGES.programchange<<4)+(this.number-1),e],{time:r.toTimestamp(t.time)}),this}sendRpnValue(e,t,s={}){if(Array.isArray(e)||(e=n.MIDI_REGISTERED_PARAMETERS[e]),u.validation){if(!Number.isInteger(e[0])||!Number.isInteger(e[1]))throw new TypeError("The specified NRPN is invalid.");if(!(e[0]>=0&&e[0]<=127))throw new RangeError("The first byte of the RPN must be between 0 and 127.");if(!(e[1]>=0&&e[1]<=127))throw new RangeError("The second byte of the RPN must be between 0 and 127.");[].concat(t).forEach(e=>{if(!(e>=0&&e<=127))throw new RangeError("The data bytes of the RPN must be between 0 and 127.")})}return this._selectRegisteredParameter(e,s),this._setCurrentParameter(t,s),this._deselectRegisteredParameter(s),this}sendTuningBank(e,t={}){if(u.validation&&(!Number.isInteger(e)||!(e>=0&&e<=127)))throw new RangeError("The tuning bank number must be between 0 and 127.");return this.sendRpnValue("tuningbank",e,t),this}sendTuningProgram(e,t={}){if(u.validation&&(!Number.isInteger(e)||!(e>=0&&e<=127)))throw new RangeError("The tuning program number must be between 0 and 127.");return this.sendRpnValue("tuningprogram",e,t),this}sendLocalControl(e,t={}){return e?this.sendChannelMode("localcontrol",127,t):this.sendChannelMode("localcontrol",0,t)}sendAllNotesOff(e={}){return this.sendChannelMode("allnotesoff",0,e)}sendAllSoundOff(e={}){return this.sendChannelMode("allsoundoff",0,e)}sendResetAllControllers(e={}){return this.sendChannelMode("resetallcontrollers",0,e)}sendPolyphonicMode(e,t={}){return"mono"===e?this.sendChannelMode("monomodeon",0,t):this.sendChannelMode("polymodeon",0,t)}get octaveOffset(){return this._octaveOffset}set octaveOffset(e){if(this.validation&&(e=parseInt(e),isNaN(e)))throw new TypeError("The 'octaveOffset' property must be an integer.");this._octaveOffset=e}get output(){return this._output}get number(){return this._number}}
/**
...
/**
   ...
   *
   * @license Apache-2.0
   */send(e,t={time:0},n=0){if(e instanceof h&&(e=r.isNode?e.data:e.rawData),e instanceof Uint8Array&&r.isNode&&(e=Array.from(e)),u.validation){if(Array.isArray(e)||e instanceof Uint8Array||(e=[e],Array.isArray(t)&&(e=e.concat(t)),t=isNaN(n)?{time:0}:{time:n}),!(parseInt(e[0])>=128&&parseInt(e[0])<=255))throw new RangeError("The first byte (status) must be an integer between 128 and 255.");e.slice(1).forEach(e=>{if(!((e=parseInt(e))>=0&&e<=255))throw new RangeError("Data bytes must be integers between 0 and 255.")}),t||(t={time:0})}return this._midiOutput.send(e,r.toTimestamp(t.time)),this}sendSysex(e,t=[],s={}){if(e=[].concat(e),t instanceof Uint8Array){const r=new Uint8Array(1+e.length+t.length+1);r[0]=n.MIDI_SYSTEM_MESSAGES.sysex,r.set(Uint8Array.from(e),1),r.set(t,1+e.length),r[r.length-1]=n.MIDI_SYSTEM_MESSAGES.sysexend,this.send(r,{time:s.time})}else{const r=e.concat(t,n.MIDI_SYSTEM_MESSAGES.sysexend);this.send([n.MIDI_SYSTEM_MESSAGES.sysex].concat(r),{time:s.time})}return this}clear(){return this._midiOutput.clear?this._midiOutput.clear():u.validation&&console.warn("The 'clear()' method has not yet been implemented in your environment."),this}sendTimecodeQuarterFrame(e,t={}){if(u.validation&&(e=parseInt(e),isNaN(e)||!(e>=0&&e<=127)))throw new RangeError("The value must be an integer between 0 and 127.");return this.send([n.MIDI_SYSTEM_MESSAGES.timecode,e],{time:t.time}),this}sendSongPosition(e=0,t={}){var s=(e=Math.floor(e)||0)>>7&127,r=127&e;return this.send([n.MIDI_SYSTEM_MESSAGES.songposition,s,r],{time:t.time}),this}sendSongSelect(e=0,t={}){if(u.validation&&(e=parseInt(e),isNaN(e)||!(e>=0&&e<=127)))throw new RangeError("The program value must be between 0 and 127");return this.send([n.MIDI_SYSTEM_MESSAGES.songselect,e],{time:t.time}),this}sendTuneRequest(e={}){return this.send([n.MIDI_SYSTEM_MESSAGES.tunerequest],{time:e.time}),this}sendClock(e={}){return this.send([n.MIDI_SYSTEM_MESSAGES.clock],{time:e.time}),this}sendStart(e={}){return this.send([n.MIDI_SYSTEM_MESSAGES.start],{time:e.time}),this}sendContinue(e={}){return this.send([n.MIDI_SYSTEM_MESSAGES.continue],{time:e.time}),this}sendStop(e={}){return this.send([n.MIDI_SYSTEM_MESSAGES.stop],{time:e.time}),this}sendActiveSensing(e={}){return this.send([n.MIDI_SYSTEM_MESSAGES.activesensing],{time:e.time}),this}sendReset(e={}){return this.send([n.MIDI_SYSTEM_MESSAGES.reset],{time:e.time}),this}sendTuningRequest(e={}){return u.validation&&console.warn("The sendTuningRequest() method has been deprecated. Use sendTuningRequest() instead."),this.sendTuneRequest(e)}sendKeyAftertouch(e,t,s={}){return null==s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(s.channels).forEach(n=>{this.channels[n].sendKeyAftertouch(e,t,s)}),this}sendControlChange(e,t,s={},a={}){if(u.validation&&(Array.isArray(s)||Number.isInteger(s)||"all"===s)){const e=s;(s=a).channels=e,"all"===s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS)}return null==s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(s.channels).forEach(n=>{this.channels[n].sendControlChange(e,t,s)}),this}sendPitchBendRange(e=0,t=0,s={}){return null==s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(s.channels).forEach(n=>{this.channels[n].sendPitchBendRange(e,t,s)}),this}setPitchBendRange(e=0,t=0,s="all",r={}){return u.validation&&(console.warn("The setPitchBendRange() method is deprecated. Use sendPitchBendRange() instead."),r.channels=s,"all"===r.channels&&(r.channels=n.MIDI_CHANNEL_NUMBERS)),this.sendPitchBendRange(e,t,r)}sendRpnValue(e,t,s={}){return null==s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(s.channels).forEach(n=>{this.channels[n].sendRpnValue(e,t,s)}),this}setRegisteredParameter(e,t=[],s="all",r={}){return u.validation&&(console.warn("The setRegisteredParameter() method is deprecated. Use sendRpnValue() instead."),r.channels=s,"all"===r.channels&&(r.channels=n.MIDI_CHANNEL_NUMBERS)),this.sendRpnValue(e,t,r)}sendChannelAftertouch(e,t={},s={}){if(u.validation&&(Array.isArray(t)||Number.isInteger(t)||"all"===t)){const e=t;(t=s).channels=e,"all"===t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS)}return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].sendChannelAftertouch(e,t)}),this}sendPitchBend(e,t={},s={}){if(u.validation&&(Array.isArray(t)||Number.isInteger(t)||"all"===t)){const e=t;(t=s).channels=e,"all"===t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS)}return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].sendPitchBend(e,t)}),this}sendProgramChange(e=0,t={},s={}){if(u.validation&&(Array.isArray(t)||Number.isInteger(t)||"all"===t)){const e=t;(t=s).channels=e,"all"===t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS)}return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].sendProgramChange(e,t)}),this}sendModulationRange(e,t,s={}){return null==s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(s.channels).forEach(n=>{this.channels[n].sendModulationRange(e,t,s)}),this}setModulationRange(e=0,t=0,s="all",r={}){return u.validation&&(console.warn("The setModulationRange() method is deprecated. Use sendModulationRange() instead."),r.channels=s,"all"===r.channels&&(r.channels=n.MIDI_CHANNEL_NUMBERS)),this.sendModulationRange(e,t,r)}sendMasterTuning(e,t={}){return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].sendMasterTuning(e,t)}),this}setMasterTuning(e,t={},s={}){return u.validation&&(console.warn("The setMasterTuning() method is deprecated. Use sendMasterTuning() instead."),s.channels=t,"all"===s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS)),this.sendMasterTuning(e,s)}sendTuningProgram(e,t={}){return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].sendTuningProgram(e,t)}),this}setTuningProgram(e,t="all",s={}){return u.validation&&(console.warn("The setTuningProgram() method is deprecated. Use sendTuningProgram() instead."),s.channels=t,"all"===s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS)),this.sendTuningProgram(e,s)}sendTuningBank(e=0,t={}){return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].sendTuningBank(e,t)}),this}setTuningBank(e,t="all",s={}){return u.validation&&(console.warn("The setTuningBank() method is deprecated. Use sendTuningBank() instead."),s.channels=t,"all"===s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS)),this.sendTuningBank(e,s)}sendChannelMode(e,t=0,s={},a={}){if(u.validation&&(Array.isArray(s)||Number.isInteger(s)||"all"===s)){const e=s;(s=a).channels=e,"all"===s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS)}return null==s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(s.channels).forEach(n=>{this.channels[n].sendChannelMode(e,t,s)}),this}sendAllSoundOff(e={}){return null==e.channels&&(e.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(e.channels).forEach(t=>{this.channels[t].sendAllSoundOff(e)}),this}sendAllNotesOff(e={}){return null==e.channels&&(e.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(e.channels).forEach(t=>{this.channels[t].sendAllNotesOff(e)}),this}sendResetAllControllers(e={},t={}){if(u.validation&&(Array.isArray(e)||Number.isInteger(e)||"all"===e)){const s=e;(e=t).channels=s,"all"===e.channels&&(e.channels=n.MIDI_CHANNEL_NUMBERS)}return null==e.channels&&(e.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(e.channels).forEach(t=>{this.channels[t].sendResetAllControllers(e)}),this}sendPolyphonicMode(e,t={},s={}){if(u.validation&&(Array.isArray(t)||Number.isInteger(t)||"all"===t)){const e=t;(t=s).channels=e,"all"===t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS)}return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].sendPolyphonicMode(e,t)}),this}sendLocalControl(e,t={},s={}){if(u.validation&&(Array.isArray(t)||Number.isInteger(t)||"all"===t)){const e=t;(t=s).channels=e,"all"===t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS)}return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].sendLocalControl(e,t)}),this}sendOmniMode(e,t={},s={}){if(u.validation&&(Array.isArray(t)||Number.isInteger(t)||"all"===t)){const e=t;(t=s).channels=e,"all"===t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS)}return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].sendOmniMode(e,t)}),this}sendNrpnValue(e,t,s={}){return null==s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(s.channels).forEach(n=>{this.channels[n].sendNrpnValue(e,t,s)}),this}setNonRegisteredParameter(e,t=[],s="all",r={}){return u.validation&&(console.warn("The setNonRegisteredParameter() method is deprecated. Use sendNrpnValue() instead."),r.channels=s,"all"===r.channels&&(r.channels=n.MIDI_CHANNEL_NUMBERS)),this.sendNrpnValue(e,t,r)}sendRpnIncrement(e,t={}){return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].sendRpnIncrement(e,t)}),this}incrementRegisteredParameter(e,t="all",s={}){return u.validation&&(console.warn("The incrementRegisteredParameter() method is deprecated. Use sendRpnIncrement() instead."),s.channels=t,"all"===s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS)),this.sendRpnIncrement(e,s)}sendRpnDecrement(e,t={}){return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].sendRpnDecrement(e,t)}),this}decrementRegisteredParameter(e,t="all",s={}){return u.validation&&(console.warn("The decrementRegisteredParameter() method is deprecated. Use sendRpnDecrement() instead."),s.channels=t,"all"===s.channels&&(s.channels=n.MIDI_CHANNEL_NUMBERS)),this.sendRpnDecrement(e,s)}sendNoteOff(e,t={},s={}){if(u.validation&&(Array.isArray(t)||Number.isInteger(t)||"all"===t)){const e=t;(t=s).channels=e,"all"===t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS)}return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].sendNoteOff(e,t)}),this}stopNote(e,t){return this.sendNoteOff(e,t)}playNote(e,t={},s={}){if(u.validation&&(t.rawVelocity&&console.warn("The 'rawVelocity' option is deprecated. Use 'rawAttack' instead."),t.velocity&&console.warn("The 'velocity' option is deprecated. Use 'velocity' instead."),Array.isArray(t)||Number.isInteger(t)||"all"===t)){const e=t;(t=s).channels=e,"all"===t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS)}return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].playNote(e,t)}),this}sendNoteOn(e,t={},s={}){if(u.validation&&(Array.isArray(t)||Number.isInteger(t)||"all"===t)){const e=t;(t=s).channels=e,"all"===t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS)}return null==t.channels&&(t.channels=n.MIDI_CHANNEL_NUMBERS),r.sanitizeChannels(t.channels).forEach(n=>{this.channels[n].sendNoteOn(e,t)}),this}get name(){return this._midiOutput.name}get id(){return this._midiOutput.id}get connection(){return this._midiOutput.connection}get manufacturer(){return this._midiOutput.manufacturer}get state(){return this._midiOutput.state}get type(){return this._midiOutput.type}get octaveOffset(){return this._octaveOffset}set octaveOffset(e){if(this.validation&&(e=parseInt(e),isNaN(e)))throw new TypeError("The 'octaveOffset' property must be an integer.");this._octaveOffset=e}}
/**
 ...
 * @license Apache-2.0
 * @since 3.0.0
 */class o{constructor(e=[],t={}){this.destinations=[],this.types=[...Object.keys(n.MIDI_SYSTEM_MESSAGES),...Object.keys(n.MIDI_CHANNEL_MESSAGES)],this.channels=n.MIDI_CHANNEL_NUMBERS,this.suspended=!1,Array.isArray(e)||(e=[e]),t.types&&!Array.isArray(t.types)&&(t.types=[t.types]),t.channels&&!Array.isArray(t.channels)&&(t.channels=[t.channels]),u.validation&&(e.forEach(e=>{if(!(e instanceof i))throw new TypeError("Destinations must be of type 'Output'.")}),void 0!==t.types&&t.types.forEach(e=>{if(!n.MIDI_SYSTEM_MESSAGES.hasOwnProperty(e)&&!n.MIDI_CHANNEL_MESSAGES.hasOwnProperty(e))throw new TypeError("Type must be a valid message type.")}),void 0!==t.channels&&t.channels.forEach(e=>{if(!n.MIDI_CHANNEL_NUMBERS.includes(e))throw new TypeError("MIDI channel must be between 1 and 16.")})),this.destinations=e,t.types&&(this.types=t.types),t.channels&&(this.channels=t.channels)}forward(e){this.suspended||this.types.includes(e.type)&&(e.channel&&!this.channels.includes(e.channel)||this.destinations.forEach(t=>{(!u.validation||t instanceof i)&&t.send(e)}))}}
/**
